...
class SecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                .authorizeHttpRequests(customizer -> customizer
                        .requestMatchers(HttpMethod.GET, BOOK_PATTERN).permitAll()
                        .requestMatchers(HttpMethod.POST, GET_MULTIPLE_BOOKS_PATH).permitAll()
                        .requestMatchers(HttpMethod.POST, BOOK_PATTERN).permitAll()
                        .requestMatchers(HttpMethod.DELETE, BOOK_PATTERN).permitAll()
                        .requestMatchers(HttpMethod.PATCH, BOOK_PATTERN).permitAll()
